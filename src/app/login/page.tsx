      ...
      <div className="w-full max-w-md transform scale-[1.1] origin-center transition-transform">
        <Card className="shadow-xl border-zinc-200 dark:border-zinc-800">
            ...
            <CardContent className="grid gap-4">
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  className="focus-visible:ring-[#a9d6f3]"
                  {...form.register("email")}
                />
              ...
              <div className="grid gap-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link 
                    ...
                    className="text-sm text-[#a9d6f3] hover:underline underline-offset-4"
                  >
                    Forgot password?
                  </Link>
                </div>
              ...
              <Button 
                className="w-full bg-[#a9d6f3] hover:bg-[#a9d6f3]/90 text-zinc-950 font-semibold h-11" 
                type="submit" 
          ...
          <div className="px-6 pb-8 space-y-4">
            ...
            <Button variant="outline" className="w-full h-11 border-zinc-200 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-900" onClick={handleGithubLogin}>
            ...
            <div className="text-sm text-center text-muted-foreground pt-2">
              ...
              <Link href={`/signup${next ? `?next=${encodeURIComponent(next)}` : ""}`} className="text-[#a9d6f3] font-bold hover:underline underline-offset-4">
                Sign up
              </Link>
            </div>
          </div>
